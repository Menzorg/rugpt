...
class AgentExecutor:
    ...
    async def execute(
        ...
        system_prompt += (
            ...
            "Категорически запрещено сообщать пользователю о планируемых будущих "
            "действиях: \"продолжу поиск\", \"ожидайте отчёта\", \"обработаю остальные "
            "документы\" и любые подобные фразы. "
            "Если задача превышает лимиты инструментов за одну итерацию — "
            "составь план и согласуй с пользователем ДО начала работы, "
            "но не обещай автоматического продолжения."
        )
