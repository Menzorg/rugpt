...
class Role:
    ...
    agent_scope_description: str = ""                # Description used when this role is exposed as a subagent
    ...
    def to_dict(self) -> dict:
        ...
        return {
            ...
            "agent_scope_description": self.agent_scope_description,
    ...
    def from_dict(cls, data: dict) -> "Role":
        ...
        return cls(
            ...
            agent_scope_description=data.get("agent_scope_description") or "",
