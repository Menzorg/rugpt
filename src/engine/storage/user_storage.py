    ...
    async def create(self, user: User) -> User:
        ...
        query = """
            INSERT INTO users (
                ...
                is_admin, is_active, avatar_url, created_at, updated_at, last_seen_at
            )
        ...
        row = await self.fetchrow(
            ...
            user.password_hash, user.role_id, user.is_admin, user.is_active,
    ...
    async def update(self, user: User) -> User:
        ...
        query = """
            ...
            SET name = $2, username = $3, email = $4, password_hash = $5,
                role_id = $6, is_admin = $7, is_active = $8, avatar_url = $9,
                updated_at = $10, last_seen_at = $11
            WHERE id = $1
            RETURNING *
        """
        row = await self.fetchrow(
            ...
            user.role_id, user.is_admin, user.is_active, user.avatar_url,
