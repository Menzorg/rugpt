...
|       |   +-- 015_departments.sql       # departments, department_visibility, user dept fields, org_context
|       |
|       +-- utils/
|
+-- requirements.txt
...
2. **GROUP** — Групповой чат (несколько участников)
